#ifndef IONA_DESKTOP_CORE_DISPLAY_L2D_TOUCH_MANAGER_H
#define IONA_DESKTOP_CORE_DISPLAY_L2D_TOUCH_MANAGER_H

namespace IonaDesktop {
namespace CoreDisplay {
    class L2dTouchManager
    {
    public:
...
#endif // IONA_DESKTOP_CORE_DISPLAY_L2D_TOUCH_MANAGER_H
