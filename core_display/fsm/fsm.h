...
class FSM : public QObject {
 ...
 signals:
  ...
  void sendGLObjTask(const QString task_name, const QVariant target_state,
                     const double interval, const QEasingCurve::Type curve);
 ...
 public slots:
  void onStart();
  void mouseEventDispatch(const QEvent::Type type, const Qt::MouseButton b,
                          const QPoint pt);
